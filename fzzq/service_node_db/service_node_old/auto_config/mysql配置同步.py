    ...
    def gevent_data(self, data):
        ...
        if True in configInfo:
                ...
                for key, vaule in node.items():
                    ...
                    for data in vaule:
                        ...
                        if info == 'listeners':
                            ...
                            pid_file += (data.get('value', ''),)
                        elif info == 'log_error':
                            log_error += (data.get('value', ''),)
                        elif info == 'basedir':
                            basedir += (data.get('value', ''),)
                        elif info == 'datadir':
                            datadir += (data.get('value', ''),)
                        elif info == 'version':
            ...
            res = {
                ...
                "pid_file": tuple(set(pid_file)),
                "log_error": tuple(set(log_error)),
                "basedir": tuple(set(basedir)),
                "datadir": tuple(set(datadir)),
