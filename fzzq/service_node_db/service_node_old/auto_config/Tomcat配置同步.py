            ...
            for node in servernode:
                for key, vaule in node.items():
                    ...
                    for data in vaule:
                        ...
                        elif info == 'jvm_params':
                            jvm_params += (data.get('value', ''),)
                        elif info == 'catalina_out':
                            catalina_out += (data.get('value', ''),)
            res = {
                "name": name,
                ...
                "jvm_params": tuple(set(jvm_params)),
                "catalina_out": tuple(set(catalina_out)),
            }
